...
public class KanbanRedIndexChanged
	...
	public KanbanRedIndexChanged(int redIndexLevel) {
	...
	public Event toLoad(StringTokenizer stringTokenizer) {
		KanbanRedIndexChanged event = null;

		if (stringTokenizer.hasMoreTokens()) {
			String count = stringTokenizer.nextToken();
			event = new KanbanRedIndexChanged(Integer.parseInt(count));
